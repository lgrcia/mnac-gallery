<div class="p-4 flex flex-col gap-3">
	...
	<p class="text-base/7 text-gray-600">
		...
		<a href="https://www.museunacional.cat/en/collections/medieval-gothic-art"
			>medieval Gothic art catalog</a
		>
		- the one I find the most inspiring - of the
		<a href="https://www.museunacional.cat/en">MNAC website</a>. I added some image filters and
		buttons for my own work. Enjoy!
	</p>
</div>
